...
# dimensione di un quadrato - 1,3 cm * 1,3 cm
# dimensione della chessboard - 14,3 cm * 20,8 cm

#args
#python3 capture_chessboard_and_calibrate_cameras.py --rows=11 --columns=16 --square-size=1.3 0 2 50 "calibphotos1" --calibration-folder="calibparams1"
    ...
    with ChessboardFinder((args.left, args.right)) as pair:
        for i in range(args.num_pictures):
            ...
            for side, frame in zip(("left", "right"), frames):
                ...
                filename = "{}{}.ppm".format(side, number_string)
